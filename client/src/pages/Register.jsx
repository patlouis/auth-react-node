    ...
    <div className="flex justify-center items-center h-screen">
        <div className="shadow-lg px-8 py-5 w-96">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-4">
                    <label htmlFor="username" clasName="block text-gray-700">Username</label>
                ...
                <button type="submit" className="w-full bg-green-600 hover:bg-green-700 text-white px-3 py-2 rounded">Submit</button>
            </form>
